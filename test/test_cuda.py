...
class TestCudaOptims(TestCase):
    ...
    def test_grad_scaling_autocast_fused_optimizers(
        self, device, dtype, optim_info, foreach, fused
    ):
        ...
        for optim_input in optim_inputs:
            ...
            (
                ...
                optimizer_ctor=optim_cls, optimizer_kwargs=kwargs, device="cuda:0"
            )
